    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . 'admin/vps_terjual/' . $r->id_vps ?>" class="btn btn-danger">Terual</a>
                                            <a href="<?php echo base_url() . 'admin/vps_edit/' . $r->id_vps ?>" class="btn btn-warning">edit</a>
                                            <a href="<?php echo base_url() . 'admin/vps_hapus/' . $r->id_vps ?>" class="btn btn-secondary">hapus</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        ...
                        <div class="container-fluid">
                            <form action="<?php echo base_url() . 'admin/vps_excel' ?>" method="post">
                                <div class="row mb-3">
                                    <div class="col-sm-1">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">DATA VPS TERJUAL</h5>
                        <p>VPS yang ada disini adalah vps sudah dijual, menggunakan Database sederhana</p>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . 'admin/vps_edit/' . $s->id_vps ?>" class="btn btn-warning">edit</a>
                                            <a href="<?php echo base_url() . 'admin/vps_hapus/' . $s->id_vps ?>" class="btn btn-secondary">hapus</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
