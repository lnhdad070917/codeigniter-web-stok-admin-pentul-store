            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url() . 'admin/vps_update' ?>" method="post">
                            <div class="row mb-3">
                                <label for="cpanel" class="col-sm-2 col-form-label">Panel ke - </label>
                                <div class="col-sm-10">
                                    <input type="hidden" name="id" value="<?php echo $v->id_vps ?>">
                                    <input type="text" name="panel" class="form-control" value="<?php echo $v->panel ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="cip" class="col-sm-2 col-form-label">IP RDP</label>
                                <div class="col-sm-10">
                                    <input type="text" name="ip" class="form-control" value="<?php echo $v->ip ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="core" aria-label="Default select example">
                                        <option selected value="<?php echo $v->core ?>"><?php echo $v->core ?></option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="ram" aria-label="Default select example">
                                        <option selected value="<?php echo $v->ram ?>"><?php echo $v->ram ?></option>
                                        <option value="2">2</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="username" aria-label="Default select example">
                                        <option selected value="<?php echo $v->username ?>"><?php echo $v->username ?></option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pass" class="form-control" value="<?php echo $v->pass ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="cpass2" class="col-sm-2 col-form-label">Note</label>
                                <div class="col-sm-10">
                                    <input type="text" id="cpass2" name="note" class="form-control" value="<?php echo $v->note ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="cdate" class="col-sm-2 col-form-label">Date</label>
                                <div class="col-sm-10">
                                    <input type="date" name="date" class="form-control" value="<?php echo $v->tgl_buat ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="status" aria-label="Default select example">
                                        <option selected value="<?php echo $v->status ?>"><?php echo $v->status ?></option>
