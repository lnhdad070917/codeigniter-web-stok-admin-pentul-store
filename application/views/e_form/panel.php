            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url() . 'admin/panel_update' ?>" method="post">
                            <div class="row mb-3">
                                <label for="cprovider" class="col-sm-2 col-form-label">Provider</label>
                                <div class="col-sm-10">
                                <input type="hidden" name="id" class="form-control" value="<?php echo $p->id_panel ?>">
                                    <select name="provider" class="form-select" aria-label="Default select example">
                                        <option selected value="<?php echo $p->provider ?>"><?php echo $p->provider ?></option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pass" class="form-control" value="<?php echo $p->pass ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="cpass2" class="col-sm-2 col-form-label">Note</label>
                                <div class="col-sm-10">
                                    <input type="text" name="note" class="form-control" value="<?php echo $p->note ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="cdate" class="col-sm-2 col-form-label">Date</label>
                                <div class="col-sm-10">
                                    <input type="date" name="date" class="form-control" value="<?php echo $p->tgl_buat ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
